...
const DataClassificationPage: React.FC = () => {
    ...
    const formFields = [
        {
            ...
            validation: {
                minLength: 2,
                maxLength: 100,
                errorMessage: 'Classification name must be between 2 and 100 characters'
            }
        },
        {
            name: 'description',
    ...
    return (
        <MasterScreen
            ...
            endpoint="data_classification"
            columns={columns}
            formFields={formFields}
            searchPlaceholder="Search data classifications by code, name..."
        />
    );
};
