...
const ContractDurationPage: React.FC = () => {
  const columns = [
    {
      key: 'id',
      label: 'ID',
  ...
  const formFields = [
    {
      ...
      validation: {
        minLength: 2,
        maxLength: 100,
        errorMessage: 'Duration name must be between 2 and 100 characters'
      }
    },
    {
      name: 'description',
  ...
  return (
    <MasterScreen
      ...
      endpoint="contract_duration"
      columns={columns}
      formFields={formFields}
      searchPlaceholder="Search contract durations by code, name..."
    />
  );
};
