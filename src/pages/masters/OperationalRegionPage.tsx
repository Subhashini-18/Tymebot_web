...
const OperationalRegionPage: React.FC = () => {
  const columns = [
    {
      key: 'id',
      label: 'ID',
  ...
  const formFields = [
    {
      ...
      validation: {
        minLength: 2,
        maxLength: 100,
        errorMessage: 'Region name must be between 2 and 100 characters'
      }
    },
    {
      name: 'description',
  ...
  return (
    <MasterScreen
      ...
      endpoint="operational_region"
      columns={columns}
      formFields={formFields}
      searchPlaceholder="Search operational regions by code, name..."
    />
  );
};

export default OperationalRegionPage;