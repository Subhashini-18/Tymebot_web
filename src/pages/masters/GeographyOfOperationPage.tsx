...
const GeographyOfOperationPage: React.FC = () => {
  const columns = [
    {
      key: 'id',
      label: 'ID',
  ...
  const formFields = [
    {
      ...
      validation: {
        minLength: 2,
        maxLength: 100,
        errorMessage: 'Geography name must be between 2 and 100 characters'
      }
    },
    {
      name: 'description',
  ...
  return (
    <MasterScreen
      title="Geography of Operation"
      endpoint="geography_of_operation"
      columns={columns}
      formFields={formFields}
      searchPlaceholder="Search geography of operations by code, name..."
    />
  );
};

export default GeographyOfOperationPage;