...
const ComplianceFrameworkPage: React.FC = () => {
  const columns = [
    {
      key: 'id',
      label: 'ID',
  ...
  const formFields = [
    {
      ...
      validation: {
        minLength: 2,
        maxLength: 100,
        errorMessage: 'Framework name must be between 2 and 100 characters'
      }
    },
    {
      name: 'description',
    ...
    },
    {
      ...
      label: 'Active Status',
      type: 'checkbox',
      required: false, // Allow both true and false values
    }
  ];
  ...
  return (
    <MasterScreen
      ...
      endpoint="compliance_framework"
      columns={columns}
      formFields={formFields}
      searchPlaceholder="Search compliance frameworks by code, name..."
    />
  );
};
