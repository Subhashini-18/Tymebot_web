...
const OrgCertificationPage: React.FC = () => {
  ...
  const formFields = [
    {
      ...
      validation: {
        minLength: 2,
        maxLength: 100,
        errorMessage: 'Certification name must be between 2 and 100 characters'
      }
    },
    {
      name: 'description',
  ...
  return (
    <MasterScreen
      ...
      endpoint="org_certification"
      columns={columns}
      formFields={formFields}
      searchPlaceholder="Search vendor certifications by code, name..."
    />
  );
};
